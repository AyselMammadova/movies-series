...
const GoldenGlobe = () => {
    return (
        <section className='max-md:my-7 md:my-30 max-md:py-7 max-md:pl-7 md:py-15 md:pl-10 bg-goldenrod relative before:absolute before:top-0 before:left-0 before:w-full before:h-19 before:bg-[linear-gradient(to_bottom,_goldenrod_0%,_goldenrod_80%,_rgba(0,0,0,0.1)_100%)]'>
